...
import (
	...
	_ "vocagame-be-azola/docs"
	orderHttp "vocagame-be-azola/internal/order/port/http"
	productHttp "vocagame-be-azola/internal/product/port/http"
	userHttp "vocagame-be-azola/internal/user/port/http"
